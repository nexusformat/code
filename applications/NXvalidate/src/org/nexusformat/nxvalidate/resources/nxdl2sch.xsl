...
<!--
    ...
    # $LastChangedDate: 2009-10-23 03:46:42 +0100 (Fri, 23 Oct 2009) $
    # $LastChangedBy: Freddie Akeroyd $
    # $LastChangedRevision: 437 $
    # $HeadURL: https://svn.nexusformat.org/definitions/trunk/xslt/nxdl2sch.xsl $
    ########### SVN repository information ###################
...
<xsl:stylesheet
    ...
    <xsl:template match="/">
        <xsl:comment>Generated by $Id: nxdl2sch.xsl 437 2009-10-23 02:46:42Z Freddie Akeroyd $</xsl:comment>
