...
void TagDef_separator(string& DefinitionPart, vector<string>& Tag, vector<string>& Def, string& DefinitionGrpVersion); //separate Tag from Definition part and return the Grp version of the string_location
