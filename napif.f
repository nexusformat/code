...
C *** Wrapper routines for NXAPI interface
      INTEGER FUNCTION NXOPEN(FILENAME, ACCESS_METHOD, OWNER, 
     +      OWNER_ADDRESS, OWNER_TELEPHONE_NUMBER, OWNER_FAX_NUMBER, 
     +      OWNER_EMAIL, OWNER_AFFILIATION, FILEID)
      CHARACTER*(*) FILENAME, OWNER, OWNER_ADDRESS, 
     +     OWNER_TELEPHONE_NUMBER, OWNER_FAX_NUMBER, OWNER_EMAIL, 
     +     OWNER_AFFILIATION
      BYTE IFILENAME(256), IOWNER(256), IOWNER_ADDRESS(256), 
     +  IOWNER_TELEPHONE_NUMBER(256), IOWNER_FAX_NUMBER(256), 
     +  IOWNER_EMAIL(256), IOWNER_AFFILIATION(256)
      INTEGER ACCESS_METHOD
      INTEGER FILEID(*),NXIFOPEN
      EXTERNAL NXIFOPEN
      CALL EXTRACT_STRING(IFILENAME, 256, FILENAME)
      NXOPEN = NXIFOPEN(IFILENAME, ACCESS_METHOD, IOWNER, 
     +             IOWNER_ADDRESS, IOWNER_TELEPHONE_NUMBER, 
     +             IOWNER_FAX_NUMBER, IOWNER_EMAIL,
     +             IOWNER_AFFILIATION, FILEID)
      END
